"""
Django settings for test_django_encrypted_json_fields project.
...
INSTALLED_APPS = [
    'test_django_encrypted_json_fields',
    'django_light',
...
ROOT_URLCONF = 'test_django_encrypted_json_fields.urls'
...
WSGI_APPLICATION = 'test_django_encrypted_json_fields.wsgi.application'
